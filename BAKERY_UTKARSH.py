...
if choice==1:
    user=input("Enter Your Userid : ").upper()
    ...
    if pas=='pms@1':
        ...
        while ch!='N' or ch!='n':
            ...
            if c==1:
                ...
                def update():
                    p_id= int(input("Enter product id : "))
                    varities=input("Enter CAKE VARITIES Name : ").upper()
                ...
                def addw():
                    ...
                    e_name=input("Enter Employee Name : ").upper()
                    salary=int(input("entet employee salary : "))
                    post =input("enter employee position : ").upper()
    ...
    cust_name=input("enter your name : ").upper()
